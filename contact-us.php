...
<section id="contentSection">
    <div class="row">
        ...
        <div class="col-12">
         <div class="left_content">
          <div class="contact_area">
            <h2 style="background-color: skyblue; color: #000"> Visit us anytime </h2>
            <?php 
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        <div class="left_content">
          <div class="contact_area">
            <h2 style="background-color: skyblue; color: #000;">Contact Us</h2>
            <h4 class="text-center">We're open for any suggestion our response service is available 24/7</h4>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="right_content" style=" position: relative;">
            <div class="contact_area" style="font-size:20px;" >
              ...
              <h2 style="background-color: skyblue; color: #000;">Get In Touch</h2>
  ...
  <footer id="footer">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
          ...
          <?php 
            ...
            <address>
              ...
              <P>  Phone: <a  style="color:rgb(000,000,000);" href="tel:<?php echo $phn ?>"> <?php echo $phn; ?> </a></P>
              <p>Email : <a style="color:rgb(000,000,000);" href = "mailto:<?php echo $email; ?>"> <?php echo $email; ?> </a> </p>
              <p>Fax : <a style="color:rgb(000,000,000);" href="fax:<?php echo $fax; ?>"> <?php echo $fax; ?> </a> </p>
            </address>
    ...
    <div class="footer_bottom" style="background-color: skyblue; color: #000">
      <p class="copyright">Copyright &copy; <?php echo date("Y" , strtotime("now") ); ?> <a href="./index.php" style="color: blue;">Fritong Post Newspaper</a></p>
      <p class="developer" style="color:#000;">Developed By BESTMAN</p>
      <!-- Wpfreeware -->
    </div>
  </footer>
</div>
