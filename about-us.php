        ...
        <div class="col-lg3-3 col-md-3 col-sm-12">
         <div class="left_content">
          <div class="contact_area">
              <h2 style="background: skyblue; color: #000;">ABOUT US</h2>                   
          </div>
         </div>
        </div>
...
<footer id="footer">
    ...
    <div class="footer_bottom" style="background: skyblue; color: #000">
      <p class="copyright">All Right Reserved Copyright &copy; <?php echo date("Y" , strtotime("now") ); ?> <a href="./index.php" style="color:blue;">Fritong Post Newspaper</a></p>
